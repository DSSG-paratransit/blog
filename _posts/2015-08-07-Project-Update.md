...
Below we've included some sample output of our <a href="http://stsc3000.github.io/images/posts/frankenstein/frankenstein_excited.jpg">Frankenstein algorithm</a> . The screenshot shows the algorithm checking buses within a fixed radius for their feasibility to insert a new passenger on the route. 
